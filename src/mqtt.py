...
class myMQTT():
    def discoverTime(self, device):
        topic = "homeassistant/sensor/test_sensor/time/config"
        payload = {
            "device": device,
            "name": "Time",
    ...
    def discoverTemperature(self, device):
        topic = "homeassistant/sensor/test_sensor/temp/config"
        payload = {
            "device": device,
            "name": "Temperature",
    ...
    def discoverDistance(self, device):
        topic = "homeassistant/sensor/test_sensor/distance/config"
        payload = {
            "device": device,
            "name": "Distance",
    ...
    def discoverHeight(self, device):
        topic = "homeassistant/sensor/test_sensor/height/config"
        payload = {
            "device": device,
            "name": "Height",
    ...
    def discoverLevel(self, device):
        topic = "homeassistant/sensor/test_sensor/level/config"
        payload = {
            "device": device,
            "name": "Level",
    ...
    def discoverCapacity(self, device):
        topic = "homeassistant/sensor/test_sensor/capacity/config"
        payload = {
            "device": device,
            "name": "Capacity",
    ...
    def discoverPercent(self, device):
        topic = "homeassistant/sensor/test_sensor/percent/config"
        payload = {
            "device": device,
            "name": "Percent",
